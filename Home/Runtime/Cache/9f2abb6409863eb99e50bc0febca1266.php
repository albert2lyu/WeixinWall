...
<div class="system-message">
	<p style="height:45px;background:url(../../hxsjb/logo-system.png) no-repeat scroll 50% 50% #6D9500; padding-left:10px;line-height:45px;color:white"></p>
	<div style="padding:24px;">
		<?php if(isset($message)): ?><div class="success"><img style="margin-right: 9px;" src="../../hxsjb/success.png"><span><?php echo($message); ?></span></div>
		<?php else: ?>		
		<div class="error"><img style="margin-right: 9px; cursor:pointer;" src="../../hxsjb/error.png"/><span><?php echo($error); ?></span></div><?php endif; ?>
