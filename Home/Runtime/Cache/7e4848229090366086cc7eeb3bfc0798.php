			...
			<div id="column">
				<form name="paccout" action="" method="post" >
					<table cellpadding="0" cellspacing="0" border="0" class="gzzh">
						...
						<td colspan="2">
						<div id="did">
							<?php if($public['type'] == '1' ): ?><table cellspacing="0" cellpadding="0" border="0"  width="100%"><tr class="blue"><td width="18"></td><td>用户名　　　　 　：<input class="inpu" name="username" type="text" value="<?php echo ($public['username']); ?>"/><br/></td></tr>
							<tr class="blue"><td></td><td>密码　　　　 　　：<input class="inpu" name="password" type="text" value="<?php echo ($public['password']); ?>"/><br/><input class="inpu" name="Id" type="hidden" value="<?php echo ($public['Id']); ?>" /></td></tr></table><?php endif; ?>
							<?php if($public['type'] == '2' ): ?><table cellspacing="0" cellpadding="0" border="0" width="100%"><tr class="blue"><td width="18"></td><td>AppId　　　　 　：<input class="inpu" name="appid" type="text" value="<?php echo ($public['appid']); ?>"/><br/></td></tr><tr class="dark_blue"><td></td><td>AppSecret　　 　：<input class="inpu" name="appsecret" type="text" value="<?php echo ($public['appsecret']); ?>"/><br/><input class="inpu" name="Id" type="hidden" value="<?php echo ($public['Id']); ?>" /></td></tr></table><?php endif; ?>
						</div>	
						<td>
						</tr>
                    	<tr>
