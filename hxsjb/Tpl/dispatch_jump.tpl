...
<div class="system-message">
	...
	<div style="padding:24px;">
		...
		<div class="success"><img style="margin-right: 9px;" src="../../hxsjb/success.png"><span><?php echo($message); ?></span></div>
		<else/>		
		<div class="error"><img style="margin-right: 9px; cursor:pointer;" src="../../hxsjb/error.png"/><span><?php echo($error); ?></span></div>
		</present>
